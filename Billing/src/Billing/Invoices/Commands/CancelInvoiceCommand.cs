...
public static partial class CancelInvoiceCommandHandler
{
    ...
    public static async Task<(Result<InvoiceModel>, InvoiceCancelledEvent)> Handle(
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (rowsAffected == 0)
        {
            ...
            return (failures, new InvoiceCancelledEvent(command.InvoiceId));
        }
        ...
        var result = new InvoiceModel
        {
            ...
            Name = "Cancelled Invoice", // This should be fetched from DB
            Status = "Cancelled",
            Amount = 0, // This should be fetched from DB
            CreatedDateUtc = DateTime.UtcNow, // This should be fetched from DB
            UpdatedDateUtc = DateTime.UtcNow,
            Version = 1 // This should be incremented
        };

        var cancelledEvent = new InvoiceCancelledEvent(command.InvoiceId);
