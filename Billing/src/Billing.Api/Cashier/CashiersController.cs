...
public class CashiersController(IMessageBus bus) : ControllerBase
{
    ...
    public async Task<ActionResult<Contracts.Cashier.Models.Cashier>> GetCashier([FromRoute] Guid id, CancellationToken cancellationToken)
    {
    ...
    [HttpPost]
    [ProducesResponseType<object>(StatusCodes.Status400BadRequest)]
    public async Task<ActionResult<Contracts.Cashier.Models.Cashier>> CreateCashier([FromBody] CreateCashierCommand command,
        CancellationToken cancellationToken)
    {
    ...
    [HttpPut("{id:guid}")]
    [ProducesResponseType<object>(StatusCodes.Status400BadRequest)]
    public async Task<ActionResult<Contracts.Cashier.Models.Cashier>> UpdateCashier([FromRoute] Guid id,
