...
--changeset dev_user:"create invoice_get function" runOnChange:true
CREATE OR REPLACE FUNCTION billing.invoice_get(
    IN invoice_id uuid
)
RETURNS TABLE(
    invoice_id uuid,
...
BEGIN ATOMIC
    ...
    WHERE i.invoice_id = invoice_get.invoice_id;
END;