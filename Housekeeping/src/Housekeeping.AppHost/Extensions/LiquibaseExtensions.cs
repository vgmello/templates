...
namespace Housekeeping.AppHost.Extensions;
...
public static class LiquibaseExtensions
{
        ...
        IResourceBuilder<ParameterResource> dbPassword)
    {
        return builder
            ...
            .WithBindMount("../../infra/Housekeeping.Database/Liquibase", "/liquibase/changelog")
            ...
            .WithArgs("-c",
                """
                liquibase --url=jdbc:postgresql://housekeeping-db:5432/service_bus update --changelog-file=service_bus/changelog.xml && \
                liquibase --url=jdbc:postgresql://housekeeping-db:5432/housekeeping update --changelog-file=housekeeping/changelog.xml
                """);
    }
}
