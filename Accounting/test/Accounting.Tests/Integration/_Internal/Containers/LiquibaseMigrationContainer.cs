...
namespace Accounting.Tests.Integration._Internal.Containers;
...
public class LiquibaseMigrationContainer : IAsyncDisposable
{
    ...
    public LiquibaseMigrationContainer(string dbContainerName, INetwork containerNetwork)
    {
        ...
        _liquibaseContainer = new ContainerBuilder()
            ...
            .WithBindMount($"{baseDirectory}infra/Accounting.Database/Liquibase", "/liquibase/changelog")
            ...
            .WithCommand("-c", $"""
                                ...
                                liquibase --url=jdbc:postgresql://{dbServerSanitized}:5432/accounting update --changelog-file=accounting/changelog.xml && \
